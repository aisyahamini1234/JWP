    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <!-- form input -->
          <h3 class="card-title">Tambah Segitiga</h3><br><br>
          <div>
			<form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="varchar" class="form-control" id="alas" name="alas" placeholder="alas" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="varchar" class="form-control" id="tinggi" name="tinggi" placeholder="tinggi" required>
                        </div>
                    </div>
            ...
            <?php
                ...
                $luas = $alas * $tinggi / 2;
                  ...
                  function luas_segitiga($alas, $tinggi) { //nama function serat menangkap nilai pada kedua variabel yaitu pada nilai alas dan tinggi
                      $luas = 0.5 * ($alas * $tinggi);//rumus luas segitiga yaitu alas dikali tinggi
...
fclose($file);
                //mulai proses simpan data
                    $sql_simpan = "INSERT INTO segitiga (alas, tinggi, hasil) VALUES (
                    '".$_POST['alas']."',
                    '".$_POST['tinggi']."',
                    '".$luas."')";
			    ...
			    echo "<a href='tampil_segitiga.php'>Kembali</a>";
                }else{
